...
public class Entrainments {
    ...
    public List<sleepmachine.xml.Entrainment> getEntrainment() {
        return Entrainment;
    }

    public void setEntrainment(List<sleepmachine.xml.Entrainment> entrainment) {
    ...
    public Entrainment getselectedentrainment(String name) {
        sleepmachine.xml.Entrainment entrainment = null;
        for (sleepmachine.xml.Entrainment ent : Entrainment) {if (ent.getName().equals(name)) {entrainment = ent;}}
        if (entrainment != null) {
