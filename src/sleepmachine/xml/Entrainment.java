...
// OTHER METHODS
    ...
    // Add Intro
        currententrainmentseconds += Tools.getaudioduration(getIntro());
    // Calculate Part Time
        currententrainmentseconds += Tools.getaudioduration(getOutro());
    ...
    // Add All Parts
        ...
        for (File i : partfiles) {currententrainmentseconds += Tools.getaudioduration(i);}
    // Add Parts If Time Left
        ...
        while (currententrainmentseconds < secondslefttofill) {
            ...
            currententrainmentseconds += Tools.getaudioduration(randompartfile);
        }
    // Add Filler (If Needed)
        ...
        // Remove Last File
            ...
            currententrainmentseconds -= Tools.getaudioduration(filetoremove);
            entrainmentfiles.remove(entrainmentfiles.size() - 1);
        // Add Filler Until >= totalsessionduration
            double fillerduration = Tools.getaudioduration(getFiller());
